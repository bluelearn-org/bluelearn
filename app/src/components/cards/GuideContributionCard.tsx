...
import type { GuideRevision } from "@/types/paths"
...
type PropTypes = {
  contribution: GuideRevision;
}

export const GuideContributionCard = ({ contribution }: PropTypes) => {
  return (
    <Card className="group rounded-md bg-background shadow-none transition-colors hover:bg-muted">
      ...
      <CardHeader className="space-y-3 border-b p-6">
        ...
        <Link
          to={GuideRoute.to}
          params={{ slug: contribution.guide_id }}
        >
